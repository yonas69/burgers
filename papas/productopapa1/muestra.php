...
<body>
  ...
  <img src="kids.jpg" alt="Grand Tasty Doble" class="burger-image">
  <div class="product-info">
    <h1>papas a la Francesa Kids(Super Combo Kids)</h1>
    <p>
    Nuestras papas provienen de campos especialmente cultivados para cecyburgers, en los que se supervisa su tamaño, consistencia y valor nutricional. Además las preparamos en aceite libre de Ácidos Grasos Trans, a temperaturas reguladas y les añadimos la cantidad exacta de sal que te permite disfrutar de su excelente sabor, convirtiéndolas en una de las preferidas.
    </p>
