...
<body>
  ...
  <img src="papas_medianas.jpg" alt="Grand Tasty Doble" class="burger-image">
  <div class="product-info">
    <h1>Papas a la Francesa Medianas</h1>
    <p>
    Nuestras papas provienen de campos especialmente cultivados para Cecyburger, en los que se supervisa su tamaño, consistencia y valor nutricional. Además las preparamos en aceite libre de Ácidos Grasos Trans, a temperaturas reguladas y les añadimos la cantidad exacta de sal que te permite disfrutar de su excelente sabor, convirtiéndolas en una de las preferidas.
    </p>
